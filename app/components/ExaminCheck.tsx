...
const LIQUIDS_CHECK_LIST: CheckTask[] = [
...
export default function ExaminCheckComponent() {
  ...
  function randomizeTasks() {
    const firstIndex = Math.floor(Math.random() * LIQUIDS_CHECK_LIST.length);

    let secondIndex = Math.floor(Math.random() * LIGHTS_CHECK_LIST.length);

    setTask1(LIQUIDS_CHECK_LIST[firstIndex].value);
    setTask2(LIGHTS_CHECK_LIST[secondIndex].value);
  }
